...
public class FunctionalTests {
	...
	public void fullCircuitRacerTest() throws IOException {
		config.set("IncludeAbsoluteTimes", "false");
		prepareForCircuitContest(9);

		String path = ACCEPTANCE_PATH1 + "varvlopptid-fullt/";
		String start = path + "starttider.txt";
		String finish = path + "maltider.txt";
		String finish2 = path + "finish2.txt";
