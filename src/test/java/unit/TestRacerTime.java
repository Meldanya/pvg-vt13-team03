...
public class TestRacerTime {
	...
	public void testConstructor() {
		...
		assertEquals("Time doesn't match", testDate.getTime(),
				racerTime1.getTime());
	}
	...
	public void testBasicCompareTo() throws Exception {
		...
		assertEquals("Diff not correct", 1000,
				racerTime2.computeLapTime(compare));
	}

	@Test
	public void testComplexCompareTo() throws Exception {
		RacerTime compare = new RacerTime("22.13.14");
		assertEquals("Diff not correct",
				11 * 60 * 60 * 1000 + 60 * 1000 + 1000,
				racerTime2.computeLapTime(compare));
	}
	...
	public void testComparable() throws Exception {
		...
		assertTrue("racerTime2 not greater than time1",
				racerTime2.compareTo(time1) > 0);
		assertTrue("racerTime2 not less than time2",
				racerTime2.compareTo(time2) < 0);
	}

	@Test
	public void testFormat1Second() {
		assertEquals("Time incorrectly formatted, 1 second", "00.00.01",
				Distance.formatDuration(1000));
	}

	@Test
	public void testFormat1Minute() {
		assertEquals("Time incorrectly formatted, 1 minute", "00.01.00",
				Distance.formatDuration(60 * 1000));
	}

	@Test
	public void testFormat1Hour() {
		assertEquals("Time incorrectly formatted, 1 hour", "01.00.00",
				Distance.formatDuration(60 * 60 * 1000));
	}

	@Test
	public void testFormatArbitraryTime() {
		assertEquals(
				"Time incorrectly formatted, 1 hour",
				"25.52.28",
				Distance.formatDuration(25 * 60 * 60 * 1000 + 52 * 60 * 1000
						+ 28 * 1000));
	}
}
