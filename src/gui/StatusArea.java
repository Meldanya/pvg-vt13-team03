...
/** @author dat11ajo
 * 
 *         This class is used to give feedback to the user as to what has
 *         happened. */
public class StatusArea extends JScrollPane implements Observer {
	...
	/** @param line the String that shall be written to the bottom of the text
	 *            area */
	...
	public void update(Observable arg0, Object arg1) {
		...
		field.setText(""); // TODO: är det inte någon annans ansvar att tömma
							// inmatningsfältet?
	}
}
